...
object Constants {
    ...
    const val PREF_EXOPLAYER_DECODER_TYPE = "pref_exoplayer_decoder_type"
    const val DECODER_TYPE_AUTO = "auto"
    const val DECODER_TYPE_HARDWARE = "hardware"
    const val DECODER_TYPE_SOFTWARE = "software"
